 ...
 */
?>
<script type="text/html" id="flowmattic-application-jotform-data-template">
	<div class="flowmattic-jotform-form-data">
...
<script type="text/html" id="flowmattic-jotform-response-template">
