...
( function( $ ) {
	...
	jQuery( document ).ready( function() {
		// Workflow Trigger Emaillistverify View.
		FlowMatticWorkflow.EmaillistverifyView = FlowMatticWorkflow.ActionView.extend( {
			template: FlowMatticWorkflow.template( jQuery( '#flowmattic-application-emaillistverify-data-template' ).html() ),
