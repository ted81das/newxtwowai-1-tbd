...
function tabstoursclickhover(e){
    ...
    getTabCwrap.querySelector(":scope > .tpgb-tab-content[data-tab='" + currentTabIndex + "']").classList.add('active');
    getTabCwrap.querySelector(":scope > .tpgb-tab-content[data-tab='" + currentTabIndex + "']").classList.remove('inactive');
