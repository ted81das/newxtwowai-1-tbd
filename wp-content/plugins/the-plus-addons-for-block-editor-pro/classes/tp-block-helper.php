...
class Tpgbp_Pro_Blocks_Helper {
	...
	*/
	...
	public static function tpgb_dynamic_val($block_content = '', $block=[]){
		...
		// if(isset($block['blockName']) && !empty($block['blockName']) && $block['blockName']=='tpgb/tp-code-highlighter'){
						...
						if($array !==null){
							...
							if(has_filter('tpgb_get_dynamic_content')) {
								...
								if(is_array($dynamicVal)){
									...
									if( !empty($dynamicpara['field'] ) && isset($dynamicpara['field']['dynamicField']) && !empty($dynamicpara['field']['dynamicField']) && $dynamicpara['field']['dynamicField'] == 'tpgb-product-price-tag' ){
