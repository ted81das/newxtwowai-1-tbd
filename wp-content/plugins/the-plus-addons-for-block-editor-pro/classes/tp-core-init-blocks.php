...
class TPGBP_Pro_Init_Blocks {
    ...
    public function editor_assets() {
		...
		wp_enqueue_style('tpgb-block-editor-css', TPGBP_URL.'assets/css/admin/tpgb-blocks-editor.min.css', array('wp-edit-blocks', 'dashicons'),TPGBP_VERSION);
		
		//Editor Block build js
		global $pagenow;
		$scripts_dep = array( 'moment', 'react', 'react-dom', 'wp-block-editor', 'wp-wordcount', 'wp-blocks', 'wp-i18n','wp-plugins', 'wp-element','wp-components','wp-api-fetch','media-upload','media-editor');
