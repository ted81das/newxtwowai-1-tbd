...
function tpgb_tp_navbuilder() {
	...
	$attributesOptions = [
			...
			'ItemMenu' => array(
				...
				'default' => [ 
					[ '_key'=> 'cvi9', 'depth' => '0', 'LinkType' => 'dynamic','LinkFilter' => (Object)['openFilter' => true], 'preicon' => 'fas fa-home', 'labeltxt' => 'New', 'megaMType' => 'default' , 'menuiconTy' => '' , 'SmenuType' => 'link' , 'ajaxbase' => '' ]
				],
			),
