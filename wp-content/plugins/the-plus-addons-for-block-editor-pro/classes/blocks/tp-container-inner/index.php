	...
	$attributesOptions = [
			...
			'flexDirection' => [
                ...
                'style' => [
                    (object) [
                        ...
                        'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky { flex-direction: {{flexDirection}} }',
                        'media' => 'md',
                    ],
                    (object) [
                        'condition' => [ (object) ['key' => 'flexreverse', 'relation' => '==', 'value' => false]],
                    ...
                    (object) [
                        ...
                        'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky { flex-direction: {{flexDirection}}-reverse }',
                        'media' => 'md',
                    ],
                    (object) [
                        'condition' => [ (object) ['key' => 'flexreverse', 'relation' => '==', 'value' => true]],
                    ...
                    (object) [
                        ...
                        'selector' => '@media (max-width: 1024px) and (min-width:768px) { {{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky { flex-direction: {{flexDirection}} } }' ,
                        'media' => 'sm',
                    ],
                    (object) [
                        'condition' => [ (object) [ 'key' => 'flexRespreverse', 'relation' => '==', 'value' => true ],
                    ...
                    (object) [
                        ...
                        'selector' => '@media (max-width: 1024px) and (min-width:768px) { {{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky { flex-direction: {{flexDirection}}-reverse } }',
                        'media' => 'sm',
                    ],
                    (object) [
                        'condition' => [ (object) [ 'key' => 'flexRespreverse', 'relation' => '==', 'value' => true ],
					...
					(object) [
						'condition' => [ (object) [ 'key' => 'flexRespreverse', 'relation' => '==', 'value' => false ]],
						'selector' => '@media (max-width: 1024px){.text-center{text-align: center;}}@media (max-width: 767px) { {{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky{ flex-direction: {{flexDirection}} } }',
						'media' => 'xs',
					],
					(object) [
						'condition' => [ (object) [ 'key' => 'flexRespreverse', 'relation' => '==', 'value' => false ]],
                    ...
                    (object) [
                        ...
                        'selector' => '@media (max-width: 1024px){.text-center{text-align: center;}}@media (max-width: 767px){ {{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky{ flex-direction: {{flexDirection}}-reverse } }',
                        'media' => 'xs',
                    ],
                    (object) [
                        'condition' => [ (object) [ 'key' => 'flexRespreverse', 'relation' => '==', 'value' => true ],
			...
			'flexAlign' => [
				...
				'style' => [
					...
					(object) [
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky{ align-items : {{flexAlign}} }',
					],
				],
				'scopy' => true,
			],
			'flexJustify' => [
				...
				'style' => [
					...
					(object) [
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky{ justify-content : {{flexJustify}} }',
					],
				],
				'scopy' => true,
			],
			'flexGap' => [
				...
				'style' => [
					...
					(object) [
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky{ gap : {{flexGap}} }',
					],
				],
				'scopy' => true,
			],
			'flexwrap' => [
				...
				'style' => [
					...
					(object) [
						'condition' => [ (object) [ 'key' => 'reverseWrap', 'relation' => '==', 'value' => false ]],
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky{ flex-wrap : {{flexwrap}} }',
					],
					(object) [
					...
					(object) [
						'condition' => [ (object) ['key' => 'reverseWrap', 'relation' => '==', 'value' => true]],
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky{ flex-wrap : {{flexwrap}}-reverse }',
					],
				],
				'scopy' => true,
			],
			'alignWrap' => [
				...
				'style' => [
					...
					(object) [
						'selector' => '{{PLUS_WRAP}}.tpgb-container-col,{{PLUS_WRAP}}.tpgb-container-col .inner-wrapper-sticky{ align-content : {{alignWrap}} }',
					],
				],
				'scopy' => true,
			],
