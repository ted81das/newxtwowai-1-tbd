...
class Multisite_Helper
{
    ...
    {
        return ($this->is_network_active() && apply_filters('jlt_admin_bar_ms_support', false) ? true : false);
    }
    ...
    public function get_excluded_sites()
    {
        ...
        if (get_site_option('jlt_admin_bar_multisite_exclude')) {
            $excluded_sites = get_site_option('jlt_admin_bar_multisite_exclude');
