...
use ROLEMASTER\Libs\Recommended;
	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'',       // Ex. rolemaster-suite-settings /  edit.php?post_type=page .
				__( 'Recommended', 'rolemaster-suite' ),
				__( 'Recommended', 'rolemaster-suite' ),
				'manage_options',
				'rolemaster-suite-recommended-plugins',
