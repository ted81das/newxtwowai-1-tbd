...
CONTENT1;
		...
		$content4_strings = array(
			...
			'logs' => sprintf('<strong>%s</strong> - %s', esc_html__('Logs', 'stops-core-theme-and-plugin-updates'), esc_html__('Logs all plugin, theme, and core updates.', 'stops-core-theme-and-plugin-updates').' '.esc_html__('This tab is visible by default.', 'stops-core-theme-and-plugin-updates')),
