...
namespace ZionBuilderPro\Integrations\WooCommerce\Elements\CheckoutCoupon;
 ...
 */
class CheckoutCoupon extends WooCommerceElement {
	/**
	 * Get type
	 *
	...
	public function get_name() {
		return __( 'Checkout coupon notice', 'zionbuilder-pro' );
	}
