...
namespace ZionBuilderPro\Integrations\WooCommerce\Elements\ProductUpSells;
 ...
 */
class ProductUpSells extends WooCommerceElement {
	/**
	 * Get type
	 *
	...
	public function get_name() {
		return __( 'Product upsells', 'zionbuilder-pro' );
	}
