...
(function(vue, api, i18n, pinia) {
  ...
  const useBuilderOptions = () => {
    const fetchOptions = (force = false) => {
      ...
      return api.getSavedOptions().then((response) => {
        ...
        const newOptions = __spreadValues(__spreadValues({}, options.value), data);
    ...
    const saveOptionsToDB = () => {
      ...
      return api.saveOptions(options.value).finally(() => {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_Modal, {
          show: vue.unref(modalData2).show,
          "onUpdate:show": _cache[2] || (_cache[2] = ($event) => vue.unref(modalData2).show = $event),
          "append-to": "body",
          "show-maximize": false,
          width: 500,
          "enable-drag": false,
          title: i18n__namespace.__("Mega menu options", "zionbuilder-pro"),
          class: "zb-mmModal",
          ...
          default: vue.withCtx(() => [
                  ...
                  return vue.openBlock(), vue.createBlock(_component_Tab, {
                    ...
                    default: vue.withCtx(() => [
                      vue.createVNode(_component_OptionsForm, {
                        ...
                        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => menuValues.value = $event),
                        schema: tab.schema
                      }, null, 8, ["modelValue", "schema"]),
                      tab.id === "content" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2, [
                        menuValues.value.content_enabled ? (vue.openBlock(), vue.createBlock(_component_Button, {
                          key: 0,
                          class: "znpb-button--secondary zb-mmModalEditButton",
                          onClick: onEditButtonClick
                        }, {
                          default: vue.withCtx(() => [
                            enableMegaMenuLoading.value ? (vue.openBlock(), vue.createBlock(_component_Loader, {
                              key: 0,
                              size: 12
                            })) : vue.createCommentVNode("", true),
                            vue.createTextVNode(" " + vue.toDisplayString(i18n__namespace.__("Edit with Zion Builder", "zionbuilder-pro")), 1)
                          ]),
                          _: 1
                        })) : vue.createCommentVNode("", true)
                      ])) : vue.createCommentVNode("", true)
            ...
            showEditModal.value ? (vue.openBlock(), vue.createBlock(_component_Modal, {
              key: 2,
              show: true,
              "show-backdrop": false,
              "append-to": "body",
              ...
              "show-maximize": false,
              onCloseModal: _cache[1] || (_cache[1] = ($event) => showEditModal.value = false)
            }, {
              title: vue.withCtx(() => [
                vue.createElementVNode("span", _hoisted_3, [
                  vue.createElementVNode("span", _hoisted_4, vue.toDisplayString(i18n__namespace.__("Editing menu item", "zionbuilder-pro")), 1)
                ])
              ]),
              close: vue.withCtx(() => [
                vue.createElementVNode("span", _hoisted_5, vue.toDisplayString(i18n__namespace.__("Close menu item", "zionbuilder-pro")), 1)
              ]),
              default: vue.withCtx(() => [
            ...
            vue.createElementVNode("div", _hoisted_7, [
              vue.createVNode(_component_Button, {
                ...
                onClick: vue.withModifiers(onSaveClick, ["stop"])
              }, {
                default: vue.withCtx(() => [
                  saveLoading.value ? (vue.openBlock(), vue.createBlock(_component_Loader, {
                    key: 0,
                    size: 12
                  })) : vue.createCommentVNode("", true),
                  vue.createTextVNode(" " + vue.toDisplayString(i18n__namespace.__("Save changes", "zionbuilder-pro")), 1)
                ]),
                _: 1
              }, 8, ["onClick"])
            ])
...
})(zb.vue, zb.api, wp.i18n, zb.pinia);
