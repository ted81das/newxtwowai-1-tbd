...
jQuery(document).ready(function ($)
{
    ...
    $(document).on('click','.aiomatic-generate-button', async function(e)
    {
        ...
        for (const element of formin)
        {
            ...
            {
                if(value.length < parseInt(aiomatic_completition_ajax_object_forms.min_len, 10))
                {
            ...
            {
                if(value.length > parseInt(aiomatic_completition_ajax_object_forms.max_len, 10))
                {
                    ...
                    success: function(response) {
                        ...
                        if(response.status == 'success')
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if(aiomaticType == 'image' || aiomaticType == 'image-new' || aiomaticType == 'image-mid' || aiomaticType == 'image-rep' || aiomaticType == 'image-ide')
                                    {
