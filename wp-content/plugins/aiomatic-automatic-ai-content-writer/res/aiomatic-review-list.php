...
<div class="wrap">
        ...
        <div id="ai-video-container"><br/>
            <iframe class="ai-video<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" width="560" height="315" src="https://www.youtube.com/embed/X_sxxlbdKXU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
<?php
   }
