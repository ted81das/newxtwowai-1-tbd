...
<div class="wrap gs_popuptype_holder">
        ...
        <li><b><?php echo esc_html__("Step 2: Use the AI Forms", 'aiomatic-automatic-ai-content-writer');?>:</b> <?php echo esc_html__("You can set up the AI Forms in the front end of your site, by using the [aiomatic-form id=\"FORM_ID\"] shortcode. You can get the shortcode for each form, from the 'List AI Forms' tab from above. Here you will be able to manage (edit, delete, preview) created AI Forms.", 'aiomatic-automatic-ai-content-writer');?>
         ...
         <p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/NhbEeIXxu-0" frameborder="0" allowfullscreen></iframe></div></p>
...
Spring"]Write a short summary of how do you feel when you walk in the woods in %%current_line%%. Write using HTMl, add a h2 with a suggestive title.[/aicontent]<br/><br/></li>
   ...
   <br/><?php echo esc_html__("Example 27:", 'aiomatic-automatic-ai-content-writer');?> <b>[aiomatic-ideogram-image seed_expre='A high detail photograph of a sports car driving on the highway' image_size='1024x1024' static_content='on' copy_locally='on' cache_seconds='2592000']</b>
   <br/><?php echo esc_html__("Example 28:", 'aiomatic-automatic-ai-content-writer');?> <b>[aiomatic-ideogram-image-generator-form image_size='default' prompt_templates='' prompt_editable="on"]</b>
   </p>
