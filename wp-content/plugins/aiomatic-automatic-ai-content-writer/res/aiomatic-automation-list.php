        ...
        foreach ($default_cards as $card_id) 
        {
            if(!empty($card_id['type']))
            {
                ...
                else
                {
                    ...
                    echo '&nbsp;<input type="checkbox" class="critical-blocks" data-clone-index="xc' . uniqid() . '" id="critical-' . esc_attr($card_id['identifier']) . uniqid() . '"';
                    if($critical == true)
                    {
                        echo ' checked';
                    }
                    ...
                    echo '&nbsp;<input type="checkbox" class="disabled-blocks" data-clone-index="xc' . uniqid() . '" id="disabled-' . esc_attr($card_id['identifier']) . uniqid() . '"';
                    if($disabled == true)
                    {
                        echo ' checked';
                    }
...
else
{
    ...
    foreach ($default_block_types as $card_id) 
    {
        if(!empty($card_id['type']))
        {
            ...
            echo '<h4>' . esc_html__("Critical", 'aiomatic-automatic-ai-content-writer') . ':&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle"><div class="bws_hidden_help_text cr_min_260px disable_drag">' . esc_html__("Set if this OmniBlock is critical or not. When a Critical OmniBlock fails to generate its content correctly and it fails, it will cause the entire OmniBlock running sequence to stop. Non-critical OmniBlocks when they fail, the execution of blocks will continue, the result of the failed OmniBlock will be blank.", 'aiomatic-automatic-ai-content-writer') . '</div></div>';
            echo '&nbsp;<input type="checkbox" class="critical-blocks" data-clone-index="xc' . uniqid() . '" id="critical-' . esc_attr($ublockid) . uniqid() . '"';
            if($critical == true)
            {
                echo ' checked';
            }
            ...
            echo '<h4>' . esc_html__("Disabled", 'aiomatic-automatic-ai-content-writer') . ':&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle"><div class="bws_hidden_help_text cr_min_260px disable_drag">' . esc_html__("Set if this OmniBlock is disabled or not. The disabled OmniBlocks will be skipped from processing.", 'aiomatic-automatic-ai-content-writer') . '</div></div>';
            echo '&nbsp;<input type="checkbox" class="disabled-blocks" data-clone-index="xc' . uniqid() . '" id="disabled-' . esc_attr($ublockid) . uniqid() . '"';
            if($disabled == true)
            {
                echo ' checked';
            }
...
<div id="ai-video-containerx"><br/>
    <iframe class="ai-video<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" width="560" height="315" src="https://www.youtube.com/embed/gCbUO6Pf6ag" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
<?php
...
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/vuyssxmxP_Y" frameborder="0" allowfullscreen></iframe></div></p>
</div>
</div>
            ...
            foreach ($saved_cards as $card_id) 
            {
                ...
                if(!empty($card_id['type']))
                {
                    ...
                    else
                    {
                        ...
                        $output .= '&nbsp;<input type="checkbox" class="critical-blocks" data-clone-index="xc' . uniqid() . '" id="critical-' . esc_attr($last_id) . uniqid() . '"';
                        if($critical == true)
                        {
                            $output .= ' checked';
                        }
                        ...
                        $output .= '&nbsp;<input type="checkbox" class="disabled-blocks" data-clone-index="xc' . uniqid() . '" id="disabled-' . esc_attr($last_id) . uniqid() . '"';
                        if($disabled == true)
                        {
                            $output .= ' checked';
                        }
