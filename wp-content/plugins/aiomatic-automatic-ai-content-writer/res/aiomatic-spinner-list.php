...
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/WVccxtXQTcc" frameborder="0" allowfullscreen></iframe></div></p>
<h2><?php echo esc_html__("AI Content Editor Templates Tutorial Video", 'aiomatic-automatic-ai-content-writer');?></h2>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/pZ9EtV_t3gs" frameborder="0" allowfullscreen></iframe></div></p>
</div>
