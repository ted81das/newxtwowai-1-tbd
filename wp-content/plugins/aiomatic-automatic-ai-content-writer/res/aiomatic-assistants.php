...
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/x2mkjdOZI9Y" frameborder="0" allowfullscreen></iframe></div></p>   
</div>
    ...
    if($aiomatic_assistants->have_posts())
    {
        foreach ($aiomatic_assistants->posts as $aiomatic_assistant)
        {
            ...
            <tr>
                ...
                <button class="button button-small aiomatic_convert_assistant" id="aiomatic_convert_assistant_<?php echo $aiomatic_assistant->ID;?>" conv-id="<?php echo $aiomatic_assistant->ID;?>"><?php echo esc_html__("Convert To Persona", 'aiomatic-automatic-ai-content-writer');?></button>
                </div>
            </td>
            </tr>
            <?php
