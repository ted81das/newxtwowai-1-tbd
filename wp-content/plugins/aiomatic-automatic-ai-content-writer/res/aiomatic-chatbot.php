...
<div class="wrap gs_popuptype_holder seo_pops">
    ...
    <nav class="nav-tab-wrapper">
        ...
        <a href="#tab-0" class="nav-tab"><?php echo esc_html__("Bot Persona Selector", 'aiomatic-automatic-ai-content-writer');?></a>
...
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/QCkNkCrFi-o" frameborder="0" allowfullscreen></iframe></div></p>
</div>
...
?>
    ...
    <td class="cr_min_width_200">
    <select class="hideAssistantIDMain" autocomplete="off" id="enable_vision" name="hideAssistantIDMain aiomatic_Chatbot_Settings[enable_vision]" <?php 
    if ($assistant_id != '')
    {
        if(!empty($assistant_model))
        {
...
echo $image;?>
            <input type="hidden" <?php if ($assistant_id == ''){echo 'name="aiomatic_Chatbot_Settings[ai_avatar]"';}?> id="aiomatic_image_id" value="<?php echo $ai_avatar;?>" class="regular-text" />
...
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/XFomdusLtHc" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr>
    </table>
...
?>
    ...
    <input type="text" name="aiomatic_Chatbot_Settings[file_expiration_pdf]" class="cr_width_full" value="<?php echo esc_html($file_expiration_pdf);?>" placeholder="Example: +1 day">
        ...
        <tr><td colspan="2">
    <h2><?php echo esc_html__("Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h2>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/SkFdO5-zxFY" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr>
        </table>
</div>
    ...
    if($aiomatic_personas->have_posts())
    {
        foreach ($aiomatic_personas->posts as $aiomatic_persona)
        {
            ...
            <tr>
                ...
                <button class="button button-small button-link-delete aiomatic_delete_persona" id="aiomatic_delete_persona_<?php echo $aiomatic_persona->ID;?>" delete-id="<?php echo $aiomatic_persona->ID;?>"><?php echo esc_html__("Delete", 'aiomatic-automatic-ai-content-writer');?></button>
                <button class="button button-small aiomatic_convert_persona" id="aiomatic_convert_persona_<?php echo $aiomatic_persona->ID;?>" data-id="<?php echo $aiomatic_persona->ID;?>"><?php echo esc_html__("Convert to AI Assistant", 'aiomatic-automatic-ai-content-writer');?></button>
                </div>
            </td>
            </tr>
            <?php
...
<table class="widefat">
        <tr><td colspan="2">
    <h2><?php echo esc_html__("Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h2>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/V0aiz-b1mdQ" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr></table>
</div>
...
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/jM7RBnV7HTc" frameborder="0" allowfullscreen></iframe></div></p>
</td></tr>
</table>
</div>
...
<hr/>
<h2><?php echo esc_html__("Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h2>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/0vdlkbDD8dw" frameborder="0" allowfullscreen></iframe></div></p>
</div>
...
<tr><td colspan="2">
    <h2><?php echo esc_html__("Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h2>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/1cqpQvzHhoQ" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr>
</table>
<hr/>
</div>
...
?>
        ...
        <tr><td colspan="2">
    <h2><?php echo esc_html__("Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h2>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/AJgHEVCdqpM" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr>
        </table>
<hr/>
</div>
...
?>
        ...
        <tr><td colspan="2">
    <h2><?php echo esc_html__("Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h2>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/6RQn-v9tlek" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr>
</table>
</div>
...
?>
        ...
        <tr><td colspan="2">
    <h2><?php echo esc_html__("Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h2>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/OwCsRmsfS-0" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr>
        <tr><td colspan="2">
    <h2><?php echo esc_html__("D-ID Streaming Video Update:", 'aiomatic-automatic-ai-content-writer');?></h2>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/oaquPhw3GrQ" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr>
<?php
}
?>
...
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/M1uwngrumrg" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr>
    </table>
</div>
...
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/6y6XCrAG72U" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr>
</table>
</div>
...
?>
                    ...
                    <div>
                    <select multiple id="<?php echo $chuniqid;?>always_show" onchange="anyNewChatChanged();" class="resize_vertical cr_width_full">
<?php
...
?>
                    ...
                    <div>
                    <select multiple onchange="anyNewChatChanged();" id="<?php echo $chuniqid;?>never_show" class="resize_vertical cr_width_full">
<?php
echo '<option value="Monday">Monday</option>';
echo '<option value="Tuesday">Tuesday</option>';
echo '<option value="Wednesday">Wednesday</option>';
...
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/iE9LUaHDFNE" frameborder="0" allowfullscreen></iframe></div></p>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/qoRX4SIGXjA" frameborder="0" allowfullscreen></iframe></div></p>
        </td></tr>
</table>
</div>
...
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/5UC_l8YEAiI" frameborder="0" allowfullscreen></iframe></div></p>
<h2><?php echo esc_html__("Basic Usage Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h2>
<p class="cr_center"><div class="embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/mD_7oaCt2eM" frameborder="0" allowfullscreen></iframe></div></p>
</div>
</div>
