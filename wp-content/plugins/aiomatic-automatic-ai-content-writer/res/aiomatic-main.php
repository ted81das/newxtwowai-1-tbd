...
<?php echo esc_html__("Note 5: If you're using iThemes security, please ensure to allow PHP calls from the plugin folder, otherwise, some features of the plugin might not work.", 'aiomatic-automatic-ai-content-writer');?>
            ...
            <div class="cr_center embedtool<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>"><iframe src="https://www.youtube.com/embed/_Ft1czw-VPU" allowfullscreen></iframe></div>
            </td>
            </tr>
            </table>
            </div>
...
?>
                  ...
                  <tr class="aiomatic-title-holder"><td colspan="2"><h2 class="aiomatic-inner-title"><?php echo esc_html__("Ideogram API Settings:", 'aiomatic-automatic-ai-content-writer');?></h2></td></tr>
        <tr>
                     <th>
                        <div>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
...
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/SX2vGtKNAz4" allowfullscreen></iframe>
   </td></tr>
        ...
        <tr>
         <td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/8H45UHQ62mk" allowfullscreen></iframe>
   </td></tr>
   <tr class="aiomatic-title-holder"><td colspan="2"><h2 class="aiomatic-inner-title"><?php echo esc_html__("Replicate Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h2></td></tr>
        <tr>
         <td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/6mPa0aob4YI" allowfullscreen></iframe>
   </td></tr>
</table>     
        </div>
...
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/e5tPgqOB8ss" allowfullscreen></iframe>
   </td></tr></table>   
        </div>
...
?>
         ...
         <tr class="aiomatic-title-holder"><td colspan="2"><h2 class="aiomatic-inner-title"><?php echo esc_html__("Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h2></td></tr>
               <tr><td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/NhbEeIXxu-0" allowfullscreen></iframe>
   </td></tr>
        </table>
            </div>
...
?></p>
        ...
        <tr>
               ...
               <tr><td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/V3AZxQM9irg" allowfullscreen></iframe>
   </td></tr>
        </table>
            </div>
...
?></p>
        ...
        <tr>
               ...
               <tr><td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/XobHHz5bLos" allowfullscreen></iframe>
   </td></tr>
...
?>
            ...
            <td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/DIUZkvD4Y6U" allowfullscreen></iframe>
   </td></tr>
            ...
            <tr>
            <td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/FFjrfLJ4Re8" allowfullscreen></iframe>
   </td>
   </tr>
        </table>
            </div>
...
?>
         ...
         <tr>
            ...
            <tr>
               ...
               <tr>
               <td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/k5BFo9jcmcs" allowfullscreen></iframe>
   </td></tr>
               ...
               <tr>
               <td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/1OibwD73JIA" allowfullscreen></iframe>
   </td>
</tr>
        </table>
            </div>
...
?>
            ...
            <tr>
               ...
               <tr>
               <td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/VknKvIcKRuw" allowfullscreen></iframe>
   </td></tr>
        </table>
            </div>
...
?>
            ...
            <tr>
               ...
               <tr>
               <td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/z_mGPlBsQQA" allowfullscreen></iframe>
   </td></tr>
        </table>
            </div>
...
?></p>
        <table class="widefat">
            ...
            <ul id="aiomatic_serp_sortable">
                ...
                {
                  foreach ($serp_cards_order as $card_id) {
                     if(!empty($card_id))
                     {
...
?>
        ...
        <td class="coderevolution_block_input" colspan="2">
<iframe class="youtube-responsive<?php if(isset($aiomatic_Main_Settings['hide_videos']) && trim($aiomatic_Main_Settings['hide_videos']) == 'on'){echo ' cr_none';}?>" src="https://www.youtube.com/embed/5XjYjXG_uF8" allowfullscreen></iframe>
   </td></tr>
         </table>
        </div>
