...
namespace WPSecurityNinja\Plugin\Da\QrCode\Controllers;

use WPSecurityNinja\Plugin\Da\QrCode\Factory\LaravelQrCodeFactory;
use WPSecurityNinja\Plugin\Illuminate\Http\Request;
use Exception;
