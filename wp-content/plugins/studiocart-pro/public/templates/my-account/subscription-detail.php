<div class="ncs-my-account ncs-my-subscription-page">
            ...
            if( 'sc_subscription' == get_post_type($post_id) ){
                ...
                <div id="subscription-all"> 
                    ...
                    <?php if($order->sub_payment): ?>
                        ...
                        <p><?php echo $order->sub_item_name; ?> - <?php echo $order->sub_payment; ?>
                            <?php if($show_cancel):  ?> | 
                            ...
                            <?php if($show_pause):  ?>
                                ...
                                <?php endif;?>
                            <?php endif; ?>
                            <?php do_action('sc_account_subscription_action_links', $order);?>
                        </p>
                    <?php endif; ?>
                    ...
                    <?php do_action('sc_account_before_subscription_details', $order); ?>
    ...
    <?php 
        ...
        do_action('sc_subscription_detail_modals', $sub);
    ?>
    <!--/ Update Payment Method -->
</div>
