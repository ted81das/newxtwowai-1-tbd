...
class NCS_Cart_Collections_Metabox_Fields extends NCS_Cart_Post_Metabox_Fields {
    public function __construct() {
        ...
        add_filter('sc_product_post_type', [$this, 'add_post_type']);
        add_filter('sc_product_metabox_post_type', [$this, 'add_post_type']);
        add_filter('sc_setup_product_post_type', [$this, 'add_post_type']);
