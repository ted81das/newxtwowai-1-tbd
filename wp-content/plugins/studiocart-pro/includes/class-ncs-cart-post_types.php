...
/**
    ...
    static function register_single_post_type( $cap_type, $plural, $single, $cpt_name, $supports=false, $public=false ) {
    ...
    public function create_custom_post_type() {
        ...
        foreach ( $post_types_args as $post_type ) {
            ...
            $this::register_single_post_type( $post_type['cap_type'], $post_type['plural'], $post_type['single'], $post_type['cpt_name'], $post_type['supports'], $post_type['public'] );
